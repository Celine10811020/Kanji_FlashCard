...
A browser-based kanji flashcard app for **JLPT N5 and N4** learning.
...
The app currently supports **JLPT N5 and N4** levels, with content organized by **Lesson** (Use textbook [にほんごチャレンジ N4・N5](https://amzn.asia/d/0aTRMkgI)).  
